<div class="fixed w-full inset-0 z-50 overflow-hidden items-center animated fadeIn faster" style="background: rgba(0,0,0,.7);">
    ...
    <div class="mx-auto my-auto w-5/6 md:w-3/5 sm:h-1/2 md:h-5/6 bg-white rounded-md overflow-y-scroll">
        ...
        <div class="px-6 pb-2">
            ...
            <div class="mt-4">
                ...
                <select id="marca_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" 
                    name="marca_id" wire:model.defer="marca_id" required>
            ...
            <div class="flex justify-around w-full mt-4 text-center">
                    <button class="inline-flex items-center px-4 py-2 rounded-md bg-gray-700 font-bold text-center text-sm text-white hover:text-green-400 active:bg-gray-700 focus:outline-none focus:border-gray-700 focus:ring focus:ring-gray-600 disabled:opacity-50 transition"
                        wire:click.prevent = "modificar({{$id_modelo}})"
