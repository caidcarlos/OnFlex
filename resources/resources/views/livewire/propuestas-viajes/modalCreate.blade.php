<div class="fixed w-full inset-0 z-50 overflow-hidden items-center animated fadeIn faster" style="background: rgba(0,0,0,.7);">
    ...
    <div class="mx-auto my-auto md:w-3/5 w-5/6 h-1/2 md:h-5/6 bg-white rounded-md overflow-y-scroll">
        ...
        <div class="px-6 pb-w py-4">
            <div class="w-full p-4 md:flex mx-auto justify-around">
                ...
                <div class="mt-4 w-full md:w-1/2 mr-1">
            ...
            <div class="mt-4">
                ...
                <input type="number" max="35" id="carga_total" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" 
            ...
            <div class="mt-4">
                ...
                <textarea name="observacion" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
