                            ...
                            <tr class="hover:bg-gray-200 text-sm text-center">
                                ...
                                <td>
                                    <div class="md:flex md:justify-around text-center my-2">
                                            ...
                                            <button class="w-full md:ml-1 ml-0 md:mb-0 mt-2 inline-flex items-center px-4 py-2 rounded-md bg-gray-700 font-bold text-center text-sm text-white hover:text-green-400 active:bg-gray-700 focus:outline-none focus:border-gray-700 focus:ring focus:ring-gray-600 disabled:opacity-50 transition"
