...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-4 border-green-400 text-sm font-medium leading-5 text-white focus:outline-none focus:border-green-500 transition'
