    ...
    <div class="mx-auto my-auto md:w-2/5 w-5/6 bg-white rounded-md">
        ...
        <div class="px-6 pb-2">
            ...
            <div class="flex justify-around w-full mt-4 text-center">
                <button class="inline-flex mr-2 items-center px-4 py-2 rounded-md bg-[#303c4e] font-bold text-sm text-white hover:text-[#00f2a1] active:bg-[#303c4e] focus:outline-none focus:border-[#303c4e] focus:ring focus:ring-gray-600 disabled:opacity-50 transition"
                    wire:click.prevent = "borrar({{$camion_id}})"
                    wire:loading.attr="disabled">
                        Eliminar
                </button>
                <button class="inline-flex ml-2 items-center px-4 py-2 rounded-md bg-[#303c4e] font-bold text-sm text-white hover:text-[#00f2a1] active:bg-[#303c4e] focus:outline-none focus:border-[#303c4e] focus:ring focus:ring-gray-600 disabled:opacity-50 transition"
